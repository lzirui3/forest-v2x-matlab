function T_summary = build_step22_summary_table(T_raw)
%BUILD_STEP22_SUMMARY_TABLE Aggregate overall metrics for base vs plus validation.
...
for c = 1:numel(configs)
    for m = 1:numel(methods)
        ...
        row = table( ...
            configs(c), subT.Profile(1), subT.Vegetation(1), subT.Variant(1), methods(m), ...
            ...
            'VariableNames', {'Config','Profile','Vegetation','Variant','Method', ...
