function T_sig = build_step20_stage_significance(T_raw, stage_name, baseline_name, proposed_name)
%BUILD_STEP20_STAGE_SIGNIFICANCE Build paired significance for one key stage.
