...
method_names = ["Link-delay-aware", "DCC-like", "AoI-aware", "Confidence-driven", "Constrained Oracle"];
...
T_summary = build_step25_summary_table(rows);
T_stage_summary = build_step25_stage_summary_table(stage_rows);
...
writetable(rows, 'step25_literature_baselines_raw.csv');
writetable(stage_rows, 'step25_literature_baselines_stage_raw.csv');
writetable(T_summary, 'step25_literature_baselines_summary.csv');
writetable(T_stage_summary, 'step25_literature_baselines_stage_summary.csv');
...
disp('Step 25 complete: literature baselines multiseed comparison generated.');
