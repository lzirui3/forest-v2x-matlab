function [objective_value, aux, meta] = compute_action_risk_constrained_objective_v4( ...
    urgency, q_link, q_pos, action, relay_available, base_rate, params, event_state, context)
%COMPUTE_ACTION_RISK_CONSTRAINED_OBJECTIVE_V4 Actual-cost aligned risk objective.
%
...
actual_tx_cost = compute_actual_tx_cost_local(action, params);
aux.tx_cost = actual_tx_cost;
...
regularization = paramsafe(params, 'risk_v4_actual_cost_weight', 0.035) * actual_tx_cost ...
