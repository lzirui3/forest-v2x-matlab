function T_summary = build_step22_stage_summary_table(T_raw)
%BUILD_STEP22_STAGE_SUMMARY_TABLE Aggregate stage metrics for base vs plus validation.
...
for c = 1:numel(configs)
    for m = 1:numel(methods)
        for s = 1:numel(stages)
            ...
            row = table( ...
                configs(c), subT.Profile(1), subT.Vegetation(1), subT.Variant(1), methods(m), stages(s), ...
                ...
                'VariableNames', {'Config','Profile','Vegetation','Variant','Method','Stage', ...
