function T_summary = build_step20_stage_summary_table(T_raw)
%BUILD_STEP20_STAGE_SUMMARY_TABLE Aggregate stage metrics for Step20.
    ...
    for m = 1:numel(methods)
        for s = 1:numel(stages)
            ...
            row = table( ...
                ...
                'VariableNames', {'Config','Method','Stage', ...
