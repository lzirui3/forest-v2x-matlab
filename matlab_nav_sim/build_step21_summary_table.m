function T_summary = build_step21_summary_table(T_raw)
%BUILD_STEP21_SUMMARY_TABLE Aggregate overall metrics for forest geometry matrix.
...
for c = 1:numel(configs)
    for m = 1:numel(methods)
        ...
        row = table( ...
            configs(c), subT.Profile(1), subT.Vegetation(1), methods(m), ...
            ...
            'VariableNames', {'Config','Profile','Vegetation','Method', ...
